  ...
  return (
    <footer className={"footer"}>
      <div className="container">
        ...
        <a href="https://www.linkedin.com/in/maxwell-walin/" target="_blank" className="fab fa-linkedin fa-2x ms-3" rel="noreferrer" style={{ textDecoration: 'none', color: '#FFFFFF' }}></a>
